...
router
  .route('/login')
  .post(loginPrefix(USER_TYPES.EMPLOYEE), authController.login);
router
  .route('/forgot-password')
  .post(loginPrefix(USER_TYPES.EMPLOYEE), authController.forgotPassword);
router
  .route('/validate-reset-password')
  .post(loginPrefix(USER_TYPES.EMPLOYEE), authController.validateResetPassword);
router
  .route('/reset-password')
  .put(loginPrefix(USER_TYPES.EMPLOYEE), authController.resetPassword);
router.route('/change-password').put(loginPrefix(USER_TYPES.EMPLOYEE), authController.changePassword);
router
  .route('/logout')
